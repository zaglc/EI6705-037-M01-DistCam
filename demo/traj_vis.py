...
from detector.base.detector import DetectionResult, YOLODetector, create_detection_result
    ...
    while cap.isOpened():
        ...
        for track_id, name, conf, xywh in zip(detection_result.track_ids, detection_result.names, detection_result.conf, detection_result.boxes):
            if name and conf > 0.5:
                ...
                cv2.polylines(frame, [points], isClosed=False, color=(0, 255, 0), thickness=2)  # Use a more visible color and thinner line
