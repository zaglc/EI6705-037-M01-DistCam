...
from src.Qt_ui.ctrl_panel.ctrl_button import ctrl_btn
...
class ctrl_panel(QToolBar):
    ...
    def init_frame_btn(self, parent: QWidget):
        ...
        self.camera_btn = ctrl_btn(parent, f"src/Qt_ui/ctrl_panel/icon/icon_CAPTURE.png", -1, "CAPTURE")
        self.camera_btn.clicked.connect(self.camera_btn_slot)
        self.record_btn = ctrl_btn(parent, f"src/Qt_ui/ctrl_panel/icon/icon_RECORD.png", -1, "RECORD")
