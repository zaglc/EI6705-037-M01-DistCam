...
from src.Qt_ui.childwins.save_prefer import ResCropWidget
from src.Qt_ui.threads import QThread4VideoDisplay
from src.Qt_ui.utils import BOX_JSON_PATH, FRAME_RATIO
