...
from src.Qt_ui.childwins.vid_src_config import vid_src_config_window
from src.Qt_ui.utils import FRAME_ZOOM_LEVEL, compute_best_size4view_panel
from src.Qt_ui.view_panel.frame_window import frame_win
