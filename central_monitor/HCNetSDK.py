...
class NET_DVR_IPADDR(Structure):
    _fields_ = [("sIpV4", c_byte * 16), ("sIpV6", c_byte * 128)]  # 设备IPv4地址  # 设备IPv6地址
...
class NET_DVR_ACS_EVENT_INFO(Structure):
    _fields_ = [
        ...
        ("byCardType", c_byte),  # 卡类型：1- 普通卡，3- 非非授权名单卡，4- 巡更卡，5- 胁迫卡，6- 超级卡，7- 来宾卡，8- 解除卡，为0表示无效
...
class NET_DVR_ID_CARD_INFO_ALARM(Structure):
    _fields_ = [
        ...
        ("byCardType", c_ubyte),  # 卡类型，1-普通卡，3-非非授权名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，8-解除卡，为0无效
